...
class Response extends ResponseAbstract
{
    ...
    {
        return setrawcookie($key, $value, $expire, $path, $domain, $secure, $httponly);
    }

    protected function httpStatus($num) {
        $http = array(
    ...
    {
        $headers = $this->httpStatus($http_status_code);
        header($headers);
        return true;
    }
