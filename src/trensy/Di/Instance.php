...
class Instance
{
    ...
    public static function ensure($reference, $type = null, $container = null)
    {
        if ($reference instanceof $type) {
            ...
            \Exception('The required component is not specified.');
        }
        ...
        if ($reference instanceof self) {
            ...
            if ($component instanceof $type || $type === null) {
                ...
                \Exception('"' . $reference->id . '" refers to a ' . get_class($component) . " component. $type is expected.");
            }
        }

        $valueType = is_object($reference) ? get_class($reference) : gettype($reference);
        \Exception("Invalid data type: $valueType. $type is expected.");
    }
