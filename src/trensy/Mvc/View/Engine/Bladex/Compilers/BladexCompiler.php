...
class BladexCompiler extends Compiler implements CompilerInterface
{
    ...
    /**
     * Compile the given Bladex template contents.
     *
     * @param  string $value
     * @return string
     */
    ...
    /**
     * Compile Bladex comments into valid PHP.
     *
     * @param  string $value
     * @return string
     */
    ...
    /**
     * Compile Bladex echos into valid PHP.
     *
     * @param  string $value
     * @return string
     */
    ...
    /**
     * Compile Bladex statements that start with "@".
     *
     * @param  string $value
     * @return mixed
     */
...
//                $match[0] = $this->$method(Arr::get($match, 3));
    ...
    /**
     * Register a custom Bladex compiler.
     *
    ...
    {
        return "\\Trensy\\Support\\Lang::get{$expression}";
    }
